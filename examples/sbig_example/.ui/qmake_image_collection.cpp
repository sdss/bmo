/****************************************************************************
** Image collection for project 'ccdOpsLite'.
**
...
**      images/searchfind
**
** Created: Wed Feb 16 11:24:11 2005
...
class MimeSourceFactory_ccdOpsLite : public QMimeSourceFactory
{
public:
    MimeSourceFactory_ccdOpsLite() {}
    ~MimeSourceFactory_ccdOpsLite() {}
...
void qInitImages_ccdOpsLite()
{
    if ( !factory ) {
	factory = new MimeSourceFactory_ccdOpsLite;
	QMimeSourceFactory::defaultFactory()->addFactory( factory );
    }
}

void qCleanupImages_ccdOpsLite()
{
    if ( factory ) {
...
class StaticInitImages_ccdOpsLite
{
public:
    StaticInitImages_ccdOpsLite() { qInitImages_ccdOpsLite(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_ccdOpsLite() { }
#else
    ~StaticInitImages_ccdOpsLite() { qCleanupImages_ccdOpsLite(); }
#endif
};

static StaticInitImages_ccdOpsLite staticImages;
